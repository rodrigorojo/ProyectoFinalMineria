...
------------------------------------------------------------------------------------------------
SELECT (SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 1 AND 18 AND TOTAL = ' >50K') as "1-18", 
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 19 AND 24 AND TOTAL = ' >50K') as "19-18", 
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 25 AND 30 AND TOTAL = ' >50K') as "25-30",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 30 AND 34 AND TOTAL = ' >50K') as "30-24",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 35 AND 37 AND TOTAL = ' >50K') as "35-37",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 38 AND 39 AND TOTAL = ' >50K') as "38-39",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 40 AND 40 AND TOTAL = ' >50K') as "40",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 41 AND 44 AND TOTAL = ' >50K') as "41-44",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 45 AND 45 AND TOTAL = ' >50K') as "45",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 46 AND 49 AND TOTAL = ' >50K') as "46-49",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 50 AND 50 AND TOTAL = ' >50K') as "50",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 51 AND 59 AND TOTAL = ' >50K') as "51-59",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 60 AND 64 AND TOTAL = ' >50K') as "60-64",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 65 AND 89 AND TOTAL = ' >50K') as "65-89",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 90 AND 99 AND TOTAL = ' >50K') as "?",
