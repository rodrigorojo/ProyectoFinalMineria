...
SELECT (SELECT COUNT(*) FROM ADULT WHERE WORKCLASS = ' Private' AND TOTAL = ' <=50K') AS "Private", 
	...
	(SELECT COUNT(*) FROM ADULT WHERE WORKCLASS = ' Without-pay' AND TOTAL = ' <=50K') AS "Without- pay", 
	(SELECT COUNT(*) FROM ADULT WHERE WORKCLASS = ' Never-worked' AND TOTAL = ' <=50K') AS "Never-worked",
	(SELECT COUNT(*) FROM ADULT WHERE WORKCLASS = ' ?' AND TOTAL = ' <=50K') AS "?",
	(SELECT COUNT(*) FROM ADULT WHERE TOTAL = ' <=50K') AS "Total"
UNION ALL
...
SELECT (SELECT COUNT(*) FROM ADULT WHERE OCCUPATION = ' Tech-support' AND TOTAL = ' >50K') AS "Tech-support",
	...
	(SELECT COUNT(*) FROM ADULT WHERE OCCUPATION = ' ?' AND TOTAL = ' >50K') AS "?",
...
SELECT (SELECT COUNT(*) FROM ADULT WHERE RACE = ' White' AND TOTAL = ' >50K') AS "White",
	...
	(SELECT COUNT(*) FROM ADULT WHERE RACE = ' Other' AND TOTAL = ' >50K') AS "Other",
...
------------------------------------------------------------------------------------------------
SELECT (SELECT COUNT(*) FROM ADULT WHERE CAPITAL_GAIN = 0 AND TOTAL = ' >50K') AS "CERO",
	(SELECT COUNT(*) FROM ADULT WHERE CAPITAL_GAIN > 0 AND TOTAL = ' >50K') AS "MAYOR-CERO",
...
SELECT (SELECT COUNT(*) FROM ADULT WHERE CAPITAL_GAIN = 0 AND TOTAL = ' <=50K') AS "CERO",
	...
	(SELECT COUNT(*) FROM ADULT WHERE TOTAL = ' <=50K') AS "Total"
UNION ALL
SELECT (SELECT COUNT(*) FROM ADULT WHERE CAPITAL_GAIN = 0) AS "CERO",
	(SELECT COUNT(*) FROM ADULT WHERE CAPITAL_GAIN > 0) AS "MAYOR-CERO",
	(SELECT COUNT(*) FROM ADULT) AS "Total";
SELECT * FROM FRECUENCIAS_CAPITAL_GAIN;
------------------------------------------------------------------------------------------------
-- FRECUENCIAS_CAPITAL_LOSS
------------------------------------------------------------------------------------------------
SELECT (SELECT COUNT(*) FROM ADULT WHERE CAPITAL_LOSS = 0 AND TOTAL = ' >50K') AS "CERO",
	(SELECT COUNT(*) FROM ADULT WHERE CAPITAL_LOSS > 0 AND TOTAL = ' >50K') AS "MAYOR-CERO",
...
SELECT (SELECT COUNT(*) FROM ADULT WHERE CAPITAL_LOSS = 0 AND TOTAL = ' <=50K') AS "CERO",
	...
	(SELECT COUNT(*) FROM ADULT WHERE TOTAL = ' <=50K') AS "Total"
UNION ALL
SELECT (SELECT COUNT(*) FROM ADULT WHERE CAPITAL_LOSS = 0) AS "CERO",
	(SELECT COUNT(*) FROM ADULT WHERE CAPITAL_LOSS > 0) AS "MAYOR-CERO",
	(SELECT COUNT(*) FROM ADULT) AS "Total";
SELECT * FROM FRECUENCIAS_CAPITAL_LOSS;
------------------------------------------------------------------------------------------------
-- FRECUENCIAS_HOURS_PER_WEEK
------------------------------------------------------------------------------------------------
SELECT (SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 0 AND 20 AND TOTAL = ' >50K') as "10-20", 
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 21 AND 40 AND TOTAL = ' >50K') as "21-40", 
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 41 AND 60 AND TOTAL = ' >50K') as "41-60", 
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 61 AND 80 AND TOTAL = ' >50K') as "61-80", 
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 81 AND 100 AND TOTAL = ' >50K') as "81-100",
