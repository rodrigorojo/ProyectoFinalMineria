...
SELECT (SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 1 AND 18 AND TOTAL = ' >50K') as "1-18h", 
	...
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 31 AND 35 AND TOTAL = ' >50K') as "31-35h",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 36 AND 39 AND TOTAL = ' >50K') as "36-39h",
...
SELECT (SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 1 AND 18) as "1-18h", 
	...
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 31 AND 35) as "31-35h",
	(SELECT COUNT(*) FROM ADULT WHERE HOURS_PER_WEEK BETWEEN 36 AND 39) as "36-39h",
